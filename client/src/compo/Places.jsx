  ...
  return (
    <div>
      <nav className="w-full flex mt-8">
        ...
        <Link
          className="py-1 px-3 text-white  bg-primary rounded-full"
          to={"/account/places"}
        >
          My Accommodation
        </Link>
      ...
      <form>
        <div>
          ...
          <p className="text-gray-500 text-sm">Tiltle of your place.</p>
          <input
            type="text"
          ...
          />
          <h2 className="text-4xl mb-4">Photos</h2>
          <p className="text-gray-500 text-sm">minimum 2 photos please</p>
          <div>
            <div className="flex">
              <input
                type="text"
                placeholder="upload by link - https://www.website.com/_______.jpg"
                value={link}
                onChange={(ev) => setLink(ev.target.value)}
              />
              <button className="my-2 px-6 ">
                <svg
            ...
            <button className="bg-transparent text-gray-500 border-none shadow-none">
              add more from links
            </button>
          </div>
          <div className="mt-2 grid grid-cols-3  md:grid-cols-4 lg:grid-cols-5">
            <button className=" border bg-transparent rounded-xl p-10 text-4xl flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <div>
            <h2 className="text-2xl mb-4 mt-4">Select ther Perks</h2>
            <p className="text-gray-500 text-sm">
          ...
          <div className="grid gap-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <div>
              <h3 className="px-4  mt-2 -mb-1 ">Check in time</h3>
              <input type="text" placeholder="08:00 a.m" />
            </div>
            <div>
              <h3 className="px-4 mt-2 -mb-1 ">Check Out time</h3>
              <input type="text" placeholder="11:00 p.m" />
            </div>
            <div>
              <h3 className="px-4  mt-2 -mb-1 ">Max number of guests</h3>
